  ...
  return (
    ...
    <div className='form' >
           ...
           <h2 style={{marginLeft:"650px",fontSize:"35px",color:"#FF6347"}}>User-Details:</h2>
           {
            ...
            onChange={(e)=>setfirstname(e.target.value)} className="inputField"/><br/>

            <label className='label-heading'>UserName:</label><br/>
            <input type="text" name={username} value={username}  
            onChange={(e)=>setusername(e.target.value)} className="inputField"/><br/>

            <label className='label-heading'>DateOfBirth:</label><br/>
            <input type="date" name={dateofbirth} value={dateofbirth}  
            onChange={(e)=>setdateofbirth(e.target.value)} className="inputField"/><br/>

            <label className='label-heading'>PhoneNumber:</label><br/>
            <input type="number" name={phonenumber} value={phonenumber}  
            onChange={(e)=>setphonenumber(e.target.value)} className="inputField"/><br/>
            </div>

            <div style={{marginTop:"50px"}}>
            <label className='label-heading'>Email:</label><br/>
            <input type="email" name={email} value={email}  
            onChange={(e)=>setemail(e.target.value)} className="inputField"/><br/>

            <label className='label-heading'>Country:</label><br/>
            <input type="text" name={country} value={country} 
             onChange={(e)=>setcountry(e.target.value)} className="inputField"/><br/>

            <label className='label-heading'>State:</label><br/>
            <input type="text" name={state} value={state} 
             onChange={(e)=>setstate(e.target.value)} className="inputField"/><br/>

            <label className='label-heading'>City</label><br/>
            <input type="text" name={city} value={city} 
             onChange={(e)=>setcity(e.target.value)}  className="inputField"/><br/>
            </div>
